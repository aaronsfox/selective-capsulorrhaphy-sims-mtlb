#ifndef OPENSIM_CUSTOM_COORDINATE_LIMIT_FORCE_H_
#define OPENSIM_CUSTOM_COORDINATE_LIMIT_FORCE_H_
/* -------------------------------------------------------------------------- *
 *                      OpenSim:  CustomCoordinateLimitForce.h                *
 * -------------------------------------------------------------------------- *
 ...
 *
 * This custom version allows control of the coordinate being limited to be
 * handled by a different coordinate (edits made by Aaron Fox, Deakin University).
 *
 * @author Ajay Seth
 */
class OSIMPLUGIN_API CustomCoordinateLimitForce : public Force {
OpenSim_DECLARE_CONCRETE_OBJECT(CustomCoordinateLimitForce, Force);
public:
//==============================================================================
// PROPERTIES
//==============================================================================
    OpenSim_DECLARE_PROPERTY(coordinateForceApplied, std::string,
        "Coordinate (name) to be limited.");
	OpenSim_DECLARE_PROPERTY(coordinateLimiter, std::string,
        "Coordinate (name) that sets the limiting parameters.");
...
//=============================================================================
	...
	@param[in]  coordLimiter   	Coordinate that sets the parameters.
    ...
    **/
    CustomCoordinateLimitForce(const std::string& coordName, const std::string& coordLimiter, double q_upper,
        double K_upper, double q_lower, double K_lower, double damping,
        double dq, bool computeDissipationEnergy);

    //use compiler default copy constructor and assignment operator

    /** Destructor */
    ~CustomCoordinateLimitForce() override = default;
    ...
    double calcLimitForceCustom( const SimTK::State& s) const;
...
private:
	...
	// Corresponding generalized coordinate to which the coordinate actuator
    // is limited by.
    SimTK::ReferencePtr<Coordinate> _coordLimiter;

//=============================================================================
};  // END of class CustomCoordinateLimitForce
...
#endif // #ifndef OPENSIM_CUSTOM_COORDINATE_LIMIT_FORCE_H_
